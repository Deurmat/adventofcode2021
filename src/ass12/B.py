...
def generate_paths(start_cave: Cave, caves_list: list) -> list:
    ...
    while True:
        ...
        for cave_connection in cave_connections:
            ...
            if len([cave for cave in cave_connection if cave.size == 's']) > len(set([cave for cave in cave_connection if cave.size == 's'])):
                double_small = True
            else:
                double_small = False
            ...
            for connection in cave_connection[-1].connections:
                ...
                if connection_cave.size == 's' and connection_cave in cave_connection and double_small:
                    continue
